...
const ProductDetailsDuqcat = lazy(() =>
  import("./pages/website/Productdetailsduqcat")
);
const ProductDetailsKaribyshoo = lazy(() =>
  import("./pages/website/ProductdetailsKaribyshoo")
);
const ProductDetailsFoundDocument = lazy(() =>
  import("./pages/website/ProductdetailsFoundDocument")
);
const Opportunities = lazy(() => import("./pages/website/Opportunities"));
const OpportunityDetails = lazy(() =>
  import("./pages/website/OpportunityDetails")
);
const OpportunityApplication = lazy(() =>
...
const MilestoneDetail = lazy(() =>
  import("./pages/website/MilestoneDetail")
);
const MilestoneMonth = lazy(() =>
  import("./pages/website/MilestoneMonth")
);
const ActivityDetail = lazy(() =>
  import("./pages/website/ActivityDetail")
);
const ActivityDateDetail = lazy(() =>
  import("./pages/website/ActivityDateDetail")
);
const AdvisorDetail = lazy(() =>
  import("./pages/website/AdvisorDetail")
);

// Admin pages
const RaincloudDashboard = lazy(() =>
...
const PublicLayout = () => {
  ...
  React.useEffect(() => {
    ...
    if (metaDesc) {
      metaDesc.setAttribute(
        "content",
        "Empowering businesses across Africa with innovative cloud solutions, intelligent software, and actionable data analytics."
      );
    }
  }, [pathname]);
  ...
  return (
    <>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[999] focus:px-4 focus:py-2 focus:bg-white focus:text-[#72bf24] focus:border focus:border-[#72bf24] focus:rounded-lg focus:shadow-lg"
      >
      ...
      <Suspense
        fallback={
          <div className="fixed top-0 left-0 right-0 z-[200] bg-white/90 backdrop-blur-md border-b border-gray-100 h-16"></div>
        }
      >
        <Appheader />
      </Suspense>
      ...
      <Suspense
        fallback={<div className="h-32 bg-gray-50"></div>}
      >
        <FooterComponent />
      </Suspense>
    </>
...
export const routesConfig = [
  ...
  // ----------------------------------------------------
  {
    ...
    children: [
      // The About Us page is the site's landing page
      ...
      {
        path: "products/karibyshoo",
        element: <ProductDetailsKaribyshoo />,
      },
      {
        path: "products/founddocument",
        element: <ProductDetailsFoundDocument />,
      },
      { path: "products/:id", element: <ProductDetails /> },

      // New policy and sustainability pages
      ...
      {
        path: "milestone/:milestoneId/activity/:activityId",
