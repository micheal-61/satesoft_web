...
export default function Appheader() {
  ...
  const searchLinks = [
    ...
    { label: 'Net-Zero', path: '/sustainability' },
    { label: 'Carbon Reduction', path: '/sustainability' },
    { label: 'Renewable Energy', path: '/sustainability' },
    { label: 'Sustainability', path: '/sustainability' },
    { label: 'Energy Efficiency', path: '/sustainability' },
    { label: 'Water Positive', path: '/sustainability' },
    { label: 'Circular Economy', path: '/sustainability' },
    { label: 'Waste Reduction', path: '/sustainability' },
